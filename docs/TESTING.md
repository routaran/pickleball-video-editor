...
### Core test files (original three modules)

1. **tests/test_score_state.py**
...
The suite has since grown to 49 test files covering UI widgets, dialogs, video,
