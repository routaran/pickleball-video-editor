...
contain ~116 tests; the overall suite has grown to 63 test files spanning UI
...
### 3. tests/test_score_state.py (30 tests)
...
### 4. tests/test_rally_manager.py (57 tests)
...
### 5. tests/test_output.py (29 tests)
