...
1. **`{video_name}.kdenlive`** - Kdenlive MLT XML project file
2. **`{video_name}.kdenlive.ass`** - ASS subtitle file with scores
...
5. Toast notification appears: "Generated: match.kdenlive"
...
5. Success toast appears: "Generated: match.kdenlive"
