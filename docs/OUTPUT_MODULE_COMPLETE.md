...
- Outputs: {video}.kdenlive and {video}.kdenlive.ass
...
├── kdenlive_generator.py          # Kdenlive project generation
├── ffmpeg_exporter.py             # Non-blocking FFmpeg export pipeline
├── hardware_detect.py             # Detect NVENC/x264 encoder availability
└── training_data_generator.py     # ML training-data JSON sidecar emitter
...
**File Output:**
- Kdenlive project file: `{video_basename}.kdenlive`
- Subtitle file: `{video_basename}.kdenlive.ass`
